...
<div class="container">
	...
	<div class="row">
		<div class="col-md-10 offset-md-1 main-content-area">
			<div class="wrap-product-detail">
					...
					<div class="product-gallery">
						<ul class="slides">
							...
							@if ($pid >= 0)
									...
									@endforeach
							@else
									<li data-thumb="{{ $bidproduct->image }}">
										<img src="{{ $bidproduct->image }}" alt="product thumbnail" />
									</li>
							@endif
				...
				<div class="detail-info">
					...
					<h2 class="product-name">{{ $bidproduct->title }}</h2>
					<div class="short-desc pb-4">
						<ul> {!! $bidproduct->sort_description !!} </ul>
					</div>
					...
					<div class="card bg-info p-3">
						...
						@if ($bidproduct->bit_status == 1)
								<p class="availability px-4">Status: <b>Bid Running</b></p>
						@else
							<p class="availability px-4">Status: <b>Bid Ended</b></p>
						@endif
					</div> 
					<div class="wrap-price"><span class="product-price px-3"><b>Current Prize:</b> ${{ $bidproduct->regular_prize }}</span></div>
					...
					<form action="{{ route('buyer.bidstore', ['slug' => $bidproduct->slug]) }}" method="POST"> 
						@csrf 
						<div class="card-body pb-0">
							<div class="form-group">
								<input type="number" min="{{ $bidproduct->regular_prize }}+10" class="form-control"
									id="inputbid{{ $bidproduct->id }}" name="regular_prize" placeholder="Enter Your Amount">
							</div>
						</div>
				...
				<div class="advance-info">
					...
					<div class="tab-contents">
						<div class="tab-content-item active" id="description"> {!! $bidproduct->description !!} </div>
