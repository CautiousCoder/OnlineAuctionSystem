			...
			<div class="wrap-main-slide">
				<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
					<div class="item-slide">
						<img src="{{ asset('frontend') }}/images/main-slider-1-1.jpg" alt="" class="img-slide">
					...
					<div class="item-slide">
						<img src="{{ asset('frontend') }}/images/main-slider-1-2.jpg" alt="" class="img-slide">
					...
					<div class="item-slide">
						<img src="{{ asset('frontend') }}/images/main-slider-1-3.jpg" alt="" class="img-slide">
