    ...
    <div class="card">
      ...
      <form action="{{ route('user.dologin') }}" method="POST">
        ...
        <div class="card-footer mb-2 pt-4 text-center">
          <button type="submit" class="btn btn-lg btn-primary m-auto">Log In</button>
          <div class="text-center m-3">
            <h6 class="text-center">Haven't an Account. <a href="{{ route('user.register') }}">Sign Up here</a></h6>
          </div>
        </div>
      </form>
      <!-- /.form -->
